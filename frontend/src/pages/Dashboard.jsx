...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard-readable space-y-2.5 xl:flex xl:h-full xl:flex-col xl:space-y-0 xl:overflow-hidden">
      ...
      <div className="dashboard-main-grid grid w-full grid-cols-1 items-stretch gap-2.5 xl:mt-2.5 xl:min-h-0 xl:flex-1 xl:grid-cols-[minmax(680px,1fr)_270px_215px]">
      ...
      <div className={`dashboard-summary-grid relative z-10 grid grid-cols-1 items-stretch gap-2.5 ${isAdmin ? "lg:grid-cols-[minmax(0,1fr)]" : "lg:grid-cols-[262px_minmax(0,1fr)_270px] xl:w-[calc(100%+280px)]"}`}>
      {!isAdmin && (
        <section className="dashboard-welcome relative min-h-[78px] overflow-hidden rounded-xl bg-[#173d31] p-3 text-white shadow-sm" aria-label="Welcome">
