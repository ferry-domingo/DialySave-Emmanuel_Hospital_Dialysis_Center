...
import PublicAnnouncementDetail from "../../components/public/PublicAnnouncementDetail";
...
const FacilityShowcaseSlider = () => {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => setCurrent((index) => (index + 1) % photos.length), 2000);
